    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      <StyledBadge badgeContent={cart.length} color="secondary">
        <ShoppingCartIcon />
          ...
          <NavLink to="ListUser" className="navlink">רשימת משתמשים</NavLink>
          <NavLink to="AddTrampolina" className="navlink"> הוספת טרמפולינות</NavLink>
